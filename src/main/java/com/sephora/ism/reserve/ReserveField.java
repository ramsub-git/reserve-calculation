...
/**
 * Enum for all reserve calculation fields. The @ symbol in field names is
 * represented by different enum categories.
 */
public enum ReserveField {

	// ===== Key Fields =====
	DIV("DIV", FieldCategory.KEY, "Division Number"), LOC("LOC", FieldCategory.KEY, "Location Number"),
	SKU("SKU", FieldCategory.KEY, "SKU Number"), CALLFOR("CALLFOR", FieldCategory.KEY, "Record Type (OMS/FRM/JEI)"),

	// ===== Base SKULOC Fields (Input) =====
	BYCL("BYCL", FieldCategory.SKULOC, "Buyer Class"), SKUSTS("SKUSTS", FieldCategory.SKULOC, "SKULOC Status"),
	...
	// LOSTZ("LOSTZ", FieldCategory.SKULOC, "Lost/Found Units adjusted to Zero"),

	DMG("DMG", FieldCategory.SKULOC, "Damage Units - TO BE REMOVED"),
	OOBADJ("OOBADJ", FieldCategory.SKULOC, "OOB Adjustment"),
	// OOBADJZ("OOBADJZ", FieldCategory.SKULOC, "OOB Adjustment to Zero"),

	// ===== Initial Calculations =====
	INITAFS("INITAFS", FieldCategory.CALCULATED, "Initial Available For Sale"),

	// ===== Commitment Fields =====
	SNB("SNB", FieldCategory.SKULOC, "Shipped Not Billed"), SNBX("SNBX", FieldCategory.CONSTRAINT, "SNB Constraint"),
	...
	AOUTBVZ("AOUTBVZ", FieldCategory.CONSTRAINT, "AOUTBVZ Constraint Zero Adjusted"),

	// ===== Need Fields =====
	NEED("NEED", FieldCategory.SKULOC, "Retail Need"), ANEED("ANEED", FieldCategory.CALCULATED, "Adjusted Need"),
	NEEDX("NEEDX", FieldCategory.CONSTRAINT, "ANEED Constraint"),
	ANEEDZ("ANEEDZ", FieldCategory.CONSTRAINT, "ANEED Constraint Zero Adjusted"),
	...
	// ===== Final Output Fields =====
	OMSSUP("@OMSSUP", FieldCategory.OUTPUT, "OMS Supply"), RETFINAL("@RETFINAL", FieldCategory.OUTPUT, "Retail Final"),
	OMSFINAL("@OMSFINAL", FieldCategory.OUTPUT, "OMS Final"),

	// ===== Actual Value Fields =====
	SNBA("@SNBA", FieldCategory.ACTUAL, "SNB Actual"), DTCOA("@DTCOA", FieldCategory.ACTUAL, "DTCO Actual"),
	ROHPA("@ROHPA", FieldCategory.ACTUAL, "ROHP Actual"), DOTHRYA("@DOTHRYA", FieldCategory.ACTUAL, "DOTHRY Actual"),
	DOTHRNA("@DOTHRNA", FieldCategory.ACTUAL, "DOTHRN Actual"),
	RETHRYA("@RETHRYA", FieldCategory.ACTUAL, "RETHRY Actual"),
	RETHRNA("@RETHRNA", FieldCategory.ACTUAL, "RETHRN Actual"), HLDHRA("@HLDHRA", FieldCategory.ACTUAL, "HLDHR Actual"),
	DOTRSVA("@DOTRSVA", FieldCategory.ACTUAL, "DOTRSV Actual"),
	RETRSVA("@RETRSVA", FieldCategory.ACTUAL, "RETRSV Actual"),
	AOUTBVA("@AOUTBVA", FieldCategory.ACTUAL, "AOUTBV Actual"), NEEDA("@NEEDA", FieldCategory.ACTUAL, "NEED Actual"),

	// ===== System Fields =====
	LMTS("LMTS", FieldCategory.SYSTEM, "Last Modified Timestamp"), USER("USER", FieldCategory.SYSTEM, "User"),
	...
	/**
	 * Get the base field for a constraint field e.g., SNBX -> SNB
	 */
	...
	/**
	 * Get the constraint field for a base field e.g., SNB -> SNBX
	 */
	...
	public enum FieldCategory {
		KEY("Key Fields"), SKULOC("SKULOC Input Fields"), CALCULATED("Calculated Fields"),
		CONSTRAINT("Constraint Fields"), AGGREGATE("Aggregate Fields"), OUTPUT("Output Fields"),
		ACTUAL("Actual Value Fields"), SYSTEM("System Fields");
